exports.run = (client, message, args) => {
    ...
    let answers = [
        ...
        "dreamy", "Cool", "at least it's not bad", "not the best but still good", "AMAZING", "dude, that's like, awesome", `${client.emojis.cache.get("526555941953339397")}`,
        `they're cute ${client.emojis.cache.get("526168268243730459")}`, "underrated",
        ...
        `this makes me wanna ${client.emojis.cache.get("501548936084062210")}`, `what!! ${client.emojis.cache.get("506599287170400266")}`, `you better be joking ${client.emojis.cache.get("500786036889223168")}`
    ];
